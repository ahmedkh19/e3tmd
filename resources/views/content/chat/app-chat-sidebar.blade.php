...
<div class="sidebar-content">
  ...
  <div class="chat-fixed-search">
    <div class="d-flex align-items-center w-100">
      ...
      <div class="input-group input-group-merge ml-1 w-100">
        ...
        <input type="text" class="form-control round" id="chat-search" placeholder="@lang('data.Search')" aria-label="Search..." aria-describedby="chat-search" />
      </div>
    </div>
  </div>
  <!-- Sidebar header end -->
  ...
  <div id="users-list" class="chat-user-list-wrapper list-group">
    <h4 class="chat-list-title">@lang('data.Chats')</h4>

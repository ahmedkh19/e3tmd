...
<section class="app-user-edit">
  <div class="card">
    <div class="card-body">
      ...
      <form class="form-validate" enctype="multipart/form-data" method="POST" action="{{ route('users.update', $user->id) }}" >
        @csrf
        @method('PUT')
      ...
      <div class="tab-content">
        ...
        <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
          <!-- users edit media object start -->
            ...
            <?php $avatar = $user->avatar ? $user->avatar: "user.jpg"; ?>
              <img
            ...
            <div class="media mb-2">
            <?php $cover = $user->cover ? URL('/uploads/images/avatars/'.$user->cover): asset('/front/assets/img/bg/bg_a.jpg'); ?>
              <img
                      src="{{ $cover }}"
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <select class="form-control" name="status" id="status">
                  <option value="1" @if ($user->status === 1) selected @endif>@lang('data.Active')</option>
                  <option value="2" @if ($user->status === 2) selected @endif>@lang('data.inActive')</option>
                </select>
              ...
              <div class="col-lg-4 col-md-6">
                <div class="form-group">
                  ...
                  <input
                    ...
                    name="birth_date"
                    value="@if (old('birth_date')){{old('birth_date')}}@else{{$userInformation->birth_date}}@endif"
              ...
              <div class="col-lg-4 col-md-6">
                <div class="form-group">
                  ...
                  <div class="custom-control custom-radio custom-control-inline">
                    ...
                    @if (old('male')) checked @elseif ($userInformation->gender == 'male') checked @endif
                            value="male"
                    />
                  ...
                  <div class="custom-control custom-radio custom-control-inline">
                    ...
                    @if (old('female')) checked @elseif ($userInformation->gender == 'Female') checked @endif
                            value="Female"
                    />
              ...
              <div class="col-lg-4 col-md-6 form-group">
                ...
                <div class="input-group input-group-merge">
                  ...
                  <input
                    ...
                    type="text"
                    name="twitter"
                    value="@if (old('twitter')){{old('twitter')}}@else{{$userInformation->twitter}}@endif"
                    class="form-control"
                    placeholder="i3tmd"
              ...
              <div class="col-lg-4 col-md-6 form-group">
                ...
                <div class="input-group input-group-merge">
                  ...
                  <input
                    ...
                    class="form-control"
                    name="facebook"
                    value="@if (old('facebook')){{old('facebook')}}@else{{$userInformation->facebook}}@endif"
                    placeholder="i3tmd"
              ...
              <div class="col-lg-4 col-md-6 form-group">
                ...
                <div class="input-group input-group-merge">
                  ...
                  <input
                    ...
                    class="form-control"
                    name="instagram"
                    value="@if (old('instagram')){{old('instagram')}}@else{{$userInformation->instagram}}@endif"
                    placeholder="i3tmd"
              ...
              <div class="col-lg-4 col-md-6 form-group">
                ...
                <div class="input-group input-group-merge">
                  ...
                  <input
                          ...
                          class="form-control"
                          name="twitch"
                          value="@if (old('twitch')){{old('twitch')}}@else{{$userInformation->twitch}}@endif"
                          placeholder="i3tmd"
                          aria-describedby="basic-addon5"
                  />
                </div>

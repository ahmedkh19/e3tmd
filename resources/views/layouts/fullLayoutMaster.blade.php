...
<body class="vertical-layout vertical-menu-modern @if ($configData['blankPageClass']) {{$configData['blankPageClass']}} @else blank-page @endif {{ $configData['blankPageClass'] }} {{ $configData['bodyClass'] }} {{($configData['theme'] === 'dark') ? 'dark-layout' : 'light' }}

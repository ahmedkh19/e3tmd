...
(function($) {
    ...
    if($('[data-form="contact_form"]').length) {
        ...
        var alert = document.getElementById("contact_form").querySelector(".alert");
        function contact_one(say) {
            alert.style.display = 'block';
            alert.innerHTML = say;
            alert.className = "alert alert-secondary";
        }
        function contact_succsess(say) {
            alert.style.display = 'block';
            alert.innerHTML = say;
            alert.className = "alert alert-success";
        }
        function contact_error(say) {
            alert.style.display = 'block';
            alert.innerHTML = '';
            Object.keys(say).forEach(function(key) {
                alert.innerHTML += say[key][0] + '<br>';
            });
        ...
        form.submit(function (e) {
            ...
            $.ajax({
                ...
                data: form_data,
                beforeSend: contact_one("جار الارسال يرجي الانتظار ..."),
                success: function(response) {
                    if (response.error) {
                        contact_error(response.error);
                    } else {
                        contact_succsess("تم الارسال نجاح");
                    }
                },
                error: function(jqXHR, textStatus, errorThrown) {
                    if (jqXHR.status == 429) {
                        contact_one("لا يمكن ارسال اكثر من رساله واحدة في اليوم");
                    }
                }
            })
        });
    ...
    if ( _mainJS ) {
        ...
        if ( document.querySelector('[data-animeJS]') ) {
            ...
            anime_js.src = '/front/assets/plugins/lib/anime/anime.min.js';
        ...
        if ( document.querySelector('[data-slick]') ) {
            ...
            slick_js.src = '/front/assets/plugins/slick/slick.min.js';
        ...
        if ( document.querySelector('[data-parallax]') ) {
            ...
            parallax_js.src = '/front/assets/plugins/parallax/parallax.js';
        ...
        if ( document.querySelector('[data-aos]') ) {
            ...
            aos_js.src = '/front/assets/plugins/aos/aos.js';
        ...
        if ( document.querySelector('[data-countdown]') ) {
            ...
            countdown_js.src = '/front/assets/plugins/countdown/jquery.countdown.min.js';
        ...
        if ( document.querySelector('[data-scrollbar]') ) {
            ...
            nicescroll_js.src = '/front/assets/plugins/scrollbar/jquery.nicescroll.min.js';
        ...
        if ( (document.querySelector('[data-carousel="owl-carousel"]')) || (document.getElementsByClassName('owl-carousel')) ) {
            ...
            owl_carousel_js.src = '/front/assets/plugins/owl.carousel/owl.carousel.min.js';
